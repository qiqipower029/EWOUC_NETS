...
simdata <- list(S=0.05,Y=0.05, X=10^-6,rho0t = 0.05, gammat=0.6, rho0e = 0.05, gammae = 0.6, beta0t=beta0t,beta1t=beta1t, beta0e = beta0e)
...
for (i in 1:sim){
  ...
  out <- posterior(simdata$rho0t[i],simdata$rho0e[i], simdata$gammat[i], simdata$gammae[i], thetat, thetae, simdata, iteration)
