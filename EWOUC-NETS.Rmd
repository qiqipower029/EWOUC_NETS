...
simdata <- list(S=0.9,Y=0, X=0.2,rho0t = 0.05, gammat=0.6, rho0e = 0.05, gammae = 0.2, beta0t=beta0t,beta1t=beta1t, beta0e = beta0e, phi = phi)
Xmin = 0.2
Xmax = 1
...
for (i in 1:sim){
  ...
  ANETS <- inv.logit(x1)
  simdata$S[i] <- rtruncnorm(1,a=0,b=1,mean=ANETS,sd=sqrt(ANETS*(1-ANETS)/N))
